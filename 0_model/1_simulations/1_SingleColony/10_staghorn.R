...
dir.create(paste(version, "10_staghorn", timesteps, "tss", sep = "_"))
foldername = paste(version, "10_staghorn", timesteps, "tss", sep = "_")
...
for (run in 1:runs){ # multiple simulation runs
  ...
  ftsinc_list = c("staghorn") # select which functional types to include
