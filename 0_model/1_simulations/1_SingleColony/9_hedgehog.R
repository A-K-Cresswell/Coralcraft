...
dir.create(paste(version, "9_hedgehog", timesteps, "tss", sep = "_"))
foldername = paste(version, "9_hedgehog", timesteps, "tss", sep = "_")
...
for (run in 1:runs){ # multiple simulation runs
  ...
  ftypes = data.frame(names = c("encrusting", "flexi-hemispherical", "digitate", "corymbose", "tabular",
  ...
  ftsinc_list = c("hedgehog") # select which functional types to include
