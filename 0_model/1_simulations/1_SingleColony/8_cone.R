...
dir.create(paste(version, "8_cone", timesteps, "tss", sep = "_"))
foldername = paste(version, "8_cone", timesteps, "tss", sep = "_")
...
for (run in 1:runs){ # multiple simulation runs
  ...
  ftsinc_list = c("cone") # select which functional types to include
