...
dir.create(paste(version, "3_digitate", timesteps, "tss", sep = "_"))
foldername = paste(version, "3_digitate", timesteps, "tss", sep = "_")
...
for (run in 1:runs){ # multiple simulation runs
  ...
  ftsinc_list = c("digitate") # select which functional types to include
