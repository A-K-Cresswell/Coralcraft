...
dir.create(paste(version, "7_fingers", timesteps, "tss", sep = "_"))
foldername = paste(version, "7_fingers", timesteps, "tss", sep = "_")
...
for (run in 1:runs){ # multiple simulation runs
  ...
  ftsinc_list = c("fingers") # select which functional types to include
