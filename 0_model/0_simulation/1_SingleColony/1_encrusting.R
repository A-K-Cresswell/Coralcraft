...
dir.create(paste(version, "1_encrusting", timesteps, "tss", sep = "_"))
foldername = paste(version, "1_encrusting", timesteps, "tss", sep = "_")
...
for (run in 1:runs){ # multiple simulation runs
  ...
  ftsinc_list = c("encrusting") # select which functional types to include
