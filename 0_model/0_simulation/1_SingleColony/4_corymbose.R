...
dir.create(paste(version, "4_corymbose", timesteps, "tss", sep = "_"))
foldername = paste(version, "4_corymbose", timesteps, "tss", sep = "_")
...
for (run in 1:runs){ # multiple simulation runs
  ...
  ftsinc_list = c("corymbose") # select which functional types to include
