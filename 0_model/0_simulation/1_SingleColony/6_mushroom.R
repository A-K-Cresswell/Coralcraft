...
dir.create(paste(version, "6_mushroom", timesteps, "tss", sep = "_"))
foldername = paste(version, "6_mushroom", timesteps, "tss", sep = "_")
...
for (run in 1:runs){ # multiple simulation runs
  ...
  ftsinc_list = c("mushroom") # select which functional types to include
