...
allcells = data.frame(expand.grid(x=(-ws/2):(ws/2),y=(-ws/2):(ws/2),z=1:ws)) #ws/2 puts reference cell in the middle of the world
head(allcells)
...
# Note: other morphologies have and can be designed. Please contact authors if you are interested in specific morphologies not covered here.
